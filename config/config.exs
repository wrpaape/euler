...
config :euler, [problems_per_module:  10,
                ...
                c_api_exe:            "c_api",
                java_lang_tup:        {"Java", join_ansi.(~w(cyan_background red)a)},
                java_cmd:             "java",
                java_api_class_path:  Path.join(ext_api_dir, "java_api/target"),
                java_api_jar_file:    "java_api-1.0-SNAPSHOT.jar",
