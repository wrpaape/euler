...
{
  unsigned int n;
  long long unsigned int tri;
  long long unsigned int adj;
...
/*   long long unsigned int left_num_routes;  /1* running total of viable routes *1/ */
/*   long long unsigned int right_num_routes; /1* running total of viable routes *1/ */


/*   /1* struct branch_thread branch_threads[NUM_THREADS] = { *1/ */
/*   /1*   [0] *1/ */
...
/*     ++(*num_routes_ptr); /1* grid traversed or hit a wall, increment counter *1/ */
/*     return; */
/*   } */
