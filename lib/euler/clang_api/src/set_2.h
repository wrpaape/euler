...
#define DIGITS {{3, 7, 1, 0, 7, 2, 8, 7, 5, 3, 3, 9, 0, 2, 1, 0, 2, 7, 9, 8, 7, 9, 7, 9, 9, 8, 2, 2, 0, 8, 3, 7, 5, 9, 0, 2, 4, 6, 5, 1, 0, 1, 3, 5, 7, 4, 0, 2, 5, 0}, \
...
/************************************************************************************
 *                                INTIAL DECLARACTIONS                              *
 ************************************************************************************/
struct branch_args {
  int turn_value;
  int rem_turns;
  long long unsigned int *num_routes_ptr;
};

struct branch_thread {
  pthread_t thread_id;
