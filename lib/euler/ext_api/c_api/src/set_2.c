 ...
 * divisors? 																																				*
 ************************************************************************************/
char *problem_12(char *result_buffer)
{
 ...
 * numbers. (DIG_MAT)                                                               *
 ************************************************************************************/
char *problem_13(char *result_buffer)
{
  ...
  while (off_dig < off_ten) {
    ...
    sscanf(result_buffer, "%u", result[off_dig]); /* copy first ten significant digits */
    ++off_dig;
  }
 ...
 ************************************************************************************/
char *problem_14(char *result_buffer)
{
  ...
  sscanf(result_buffer, "%u", n0_max_count);
 ...
 ************************************************************************************/
char *problem_15(char *result_buffer)
{
 ...
 *********************************/
  ...
  sscanf(result_buffer, "%llu", num_routes)
