 ...
 *				HELPER FUNCTIONS			      *
 ******************************************************************************/
void do_next_digit(const long num,	/* number accumulator */
		   const long sum,	/* sum of 'num''s digits raised 5 */
		   const long nxt_pos,	/* decimal position of next digit */
		   const long *POW_MAP, /* cache of single-digit powers of 5 */
		   long *sol_sum)	/* solution accumulator */
{
	 ...
	 * because this number is unclosed, do not compare 'sum' with 'num'
	 */
	do_next_digit(num,
		      sum,
		      nxt_nxt_pos,
