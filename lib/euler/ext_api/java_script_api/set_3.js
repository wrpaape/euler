...
module.exports = {
  ...
  problem23: function() {
    ...
    var abundants, // array of accumulated abundant numbers in descending order
        maxSum,    // sum of the current two largest abundant numbers
    ...
    cutoff    = UPPER_LIMIT - 12;

    // generate abundant numbers until abundant 'n' + 12 >= 28123
    for (n = 13; n <= cutoff; n++) {
      if (isAbundant(n)) {
        abundants.push(n); // collect 'n'
      }
    }
    ...
    console.log(abundants.slice(-10));
